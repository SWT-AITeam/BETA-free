...
parser.add_argument('--pre_train_model_name', type=str, default='OneRel', help='name of the model')
...
model_name = "your pre-trained model name"

fw.testall(model[args.model_name], args.pre_train_model_name)
